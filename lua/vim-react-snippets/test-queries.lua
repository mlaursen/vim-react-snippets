...
local by_type = function(opts)
  ...
  local by_type = (type == "testid" and "TestId")
    ...
    or "Role"
  local query = maybe_await .. "screen." .. get_or_find .. "By" .. by_type
  ...
  local trig = "s" .. (find and "f" or "g") .. "b" .. char .. (is_role_unnamed and "u" or "")
  local name = "Screen " .. (find and "Find" or "Get") .. " By " .. by_type .. (is_role_unnamed and " Unnamed" or "")
